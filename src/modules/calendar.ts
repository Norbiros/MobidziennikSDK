...
import type { CalendarEntry } from '../models/calendar/calendar_entry';
...
export class Calendar extends Module {
    public async getCalendarEntries(): Promise<CalendarEntry[]> {
        ...
        const scriptTag = $('script[type="text/javascript"]').filter(
            (index, element) => {
        ...
        // biome-ignore lint/suspicious/noExplicitAny: This will be fixed in the future
